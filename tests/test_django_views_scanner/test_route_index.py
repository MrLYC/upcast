...
def test_route_index_ignores_route_calls_inside_helper_functions():
    """Only module-level URLconf expressions contribute direct route evidence."""
    module = astroid.parse(
        """
from django.urls import path
from .views import health
...
""",
    ...
    assert index.references_for("pkg.views.health") == []
