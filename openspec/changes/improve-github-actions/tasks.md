...
- [x] 1.1 Update scanner-integration.yml to normalize YAML output
...
- [x] 1.2 Add helper script for YAML normalization

  - Create `.github/scripts/compare-scan-yaml.py` or use yq with sorting
  - Ensure reproducible output format

- [x] 1.3 Update comparison logic
...
- [x] 2.1 Create new workflow `.github/workflows/publish-on-tag.yml`
