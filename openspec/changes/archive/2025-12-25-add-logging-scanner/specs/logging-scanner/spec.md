...
Detect and analyze logging patterns across Python projects, supporting multiple logging libraries with intelligent logger name resolution, message extraction, and sensitive information detection.
