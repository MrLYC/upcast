...
This specification defines the integration testing infrastructure for Upcast scanners. It ensures all scanners work correctly on real-world codebases and that scanner output remains consistent across releases.
