...
| 文件 | 行号 | 列号 | 模式 | 代码 |
|------|------|------|------|------|
| apiserver/paasng/paasng/plat_admin/admin42/context_processors.py | 24 | 23 | os.getenv('BKPAAS_BUILD_VERSION', 'unset') | os.getenv('BKPAAS_BUILD_VERSION', 'unset') |
...
| 文件 | 行号 | 列号 | 模式 | 代码 |
|------|------|------|------|------|
| apiserver/paasng/paasng/settings/__init__.py | 656 | 28 | os.environ.get('CELERY_TASK_DEFAULT_QUEUE', 'celery') | os.environ.get('CELERY_TASK_DEFAULT_QUEUE', 'celery') |
...
| 文件 | 行号 | 列号 | 模式 | 代码 |
|------|------|------|------|------|
| apiserver/paasng/paasng/utils/configs.py | 101 | 20 | os.getenv(env_key, default) | os.getenv(env_key, default) |
