...
class Function(BaseModel):
    ...
    args: list[str] = Field(default_factory=list, description="Ordered function arguments")
...
class Class(BaseModel):
    ...
    methods: dict[str, Function] = Field(default_factory=dict, description="Structured method metadata keyed by name")
