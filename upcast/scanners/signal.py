...
class SignalSummary(ScannerSummary):
    ...
    Attributes:
        total_count: Total number of signals found (inherited)
        files_scanned: Number of files scanned (inherited)
        scan_duration_ms: Scan duration in milliseconds (inherited)
    ...
    django_receivers: int = Field(default=0, ge=0)
    django_senders: int = Field(default=0, ge=0)
    celery_receivers: int = Field(default=0, ge=0)
    celery_senders: int = Field(default=0, ge=0)
    custom_signals_defined: int = Field(default=0, ge=0)
    unused_custom_signals: int = Field(default=0, ge=0)
...
class SignalOutput(ScannerOutput[list[SignalInfo]]):
    ...
    Attributes:
        ...
        metadata: Additional metadata (scanner version, timestamp, etc.)
    """
